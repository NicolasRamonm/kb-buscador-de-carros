...
function mapRowToEnrichedCar(row) {
    ...
    const image = rawImage && rawImage !== "exemplo.png" ? rawImage : `/img/${row.id}/1.png`;
    return {
        id: row.id,
        brand: row.brand,
        model: row.model,
...
"[project]/src/backend/data/city-state-map.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/backend/modules/location-resolver.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$data$2f$city$2d$state$2d$map$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/backend/data/city-state-map.ts [app-route] (ecmascript)");
;
function resolveCarState(carLocation) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$data$2f$city$2d$state$2d$map$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CITY_STATE_MAP"][carLocation] ?? null;
}
function isCarLocal(carLocation, userState) {
    if (!userState) return true;
    const carState = resolveCarState(carLocation);
    if (!carState) return true;
    return carState === userState;
}
function findClosestOption(scoredCars, recommendedCarId, userState) {
    const localCars = scoredCars.filter((sc)=>sc.car.id !== recommendedCarId && resolveCarState(sc.car.location) === userState);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$config$2f$weights$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/backend/config/weights.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$modules$2f$distance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/backend/modules/distance.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$modules$2f$location$2d$resolver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/backend/modules/location-resolver.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$data$2f$cars$2d$enriched$2e$json__$28$json$29$__ = __turbopack_context__.i("[project]/src/backend/data/cars-enriched.json (json)");
;
;
;
...
function buildRecommendation(scoredCars, intent, filterResult, userLat, userLng, userState) {
    ...
    if (userState && recommended) {
        const recIsLocal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$modules$2f$location$2d$resolver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isCarLocal"])(recommended.car.location, userState);
        if (!recIsLocal) {
            const closest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$modules$2f$location$2d$resolver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findClosestOption"])(scoredCars, recommended.car.id, userState);
            result.closestOption = closest;
            popups.showLocationHint = true;
            popups.locationHintData = {
                recommendedCarState: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$modules$2f$location$2d$resolver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveCarState"])(recommended.car.location) ?? "",
                userState
            };
        }
    }
...
async function POST(request) {
    try {
        ...
        const { query, userLat, userLng, userState } = body;
        ...
        const recommendation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$modules$2f$recommendation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildRecommendation"])(scoredCars, intent, filterResult, userLat, userLng, userState);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bf3edde8._.js.map