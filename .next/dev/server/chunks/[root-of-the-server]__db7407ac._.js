...
"[project]/src/app/img/[id]/[index]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    try {
        ...
        const baseDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "src", "backend", "data", "img", folder);
        const tryCandidates = [];
        ...
        for (const ext of exts){
            tryCandidates.push(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(baseDir, `${indexNumber}${ext}`));
        }
        // Special case: main image for Onix is named "onix.png"
        if (id === "chevrolet-onix" && indexNumber === 1) {
            tryCandidates.unshift(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(baseDir, "onix.png"));
        }
        let foundPath = null;
        ...
        const fileBuffer = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].promises.readFile(foundPath);
        const ext = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].extname(foundPath) || ".png";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__db7407ac._.js.map